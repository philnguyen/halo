...
(assert (forall ((f T) (a T) (xs T) (z T) (zs T)) (= (f-foldr f a (k-Cons z zs)) (app (app f z) (app (app (app ptr-rec-foldr f) a) zs)))))
...
(assert
 (forall
  ((f T))
  (=> (forall ((x T)) (=> (cf x) (forall ((y T)) (=> (cf y) (cf (app (app f x) y)))))) (forall ((a T)) (=> (cf a) (forall ((xs T)) (=> (cf xs) (cf (app (app (app ptr-rec-foldr f) a) xs)))))))))
(assert
 (not
