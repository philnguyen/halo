...
(assert (forall ((x T)) (=> (and (cf x) (or (= x unr) (= (app ptr-cons? x) unr) (= (app ptr-cons? x) k-True))) (cf (app ptr-rec-head x)))))
(assert (not (forall ((x T)) (=> (and (cf x) (or (= x unr) (= (app ptr-cons? x) unr) (= (app ptr-cons? x) k-True))) (cf (app ptr-head x))))))
(check-sat)